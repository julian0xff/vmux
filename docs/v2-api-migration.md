...
- use a v2 JSON client (`tests_v2/vmux.py`)
- avoid depending on v1 text output formats

VM runners:
- v1: `ssh vmux-vm 'cd /Users/vmux/GhosttyTabs && ./scripts/run-tests-v1.sh'`
- v2: `ssh vmux-vm 'cd /Users/vmux/GhosttyTabs && ./scripts/run-tests-v2.sh'`
