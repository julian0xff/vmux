# vmux terminfo overlay

vmux ships Ghostty's `xterm-ghostty` terminfo entry, but the embedded
renderer in vmux has differed from Ghostty's app renderer in how it treats
