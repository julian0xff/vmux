...
final class BrowserPaneNavigationKeybindUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/vmux-ui-test-goto-split-\(UUID().uuidString).json"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocused() {
        ...
        app.launchEnvironment["VMUX_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["VMUX_UI_TEST_FOCUS_SHORTCUTS"] = "1"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocusedUsingGhosttyConfigKeybind() {
        ...
        app.launchEnvironment["VMUX_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        app.launchEnvironment["VMUX_SOCKET_PATH"] = socketPath
        app.launchEnvironment["VMUX_UI_TEST_GOTO_SPLIT_USE_GHOSTTY_CONFIG"] = "1"
        launchAndEnsureForeground(app)
    ...
    func testEscapeRestoresFocusedPageInputAfterCmdL() {
        ...
        app.launchEnvironment["VMUX_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["VMUX_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        app.launchEnvironment["VMUX_UI_TEST_GOTO_SPLIT_INPUT_SETUP"] = "1"
        launchAndEnsureForeground(app)
    ...
    private func runFindFocusPersistenceScenario(route: FindFocusRoute, useAutofocusRacePage: Bool) {
        let app = XCUIApplication()
        app.launchEnvironment["VMUX_SOCKET_PATH"] = socketPath
        app.launchEnvironment["VMUX_UI_TEST_GOTO_SPLIT_RECORD_ONLY"] = "1"
        app.launchEnvironment["VMUX_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
