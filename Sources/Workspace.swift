...
func vmuxCurrentSurfaceFontSizePoints(_ surface: ghostty_surface_t) -> Float? {
...
func vmuxInheritedSurfaceConfig(
    ...
    let runtimePoints = vmuxCurrentSurfaceFontSizePoints(sourceSurface)
    ...
    dlog(
        "zoom.inherit context=\(vmuxSurfaceContextName(context)) " +
...
final class Workspace: Identifiable, ObservableObject {
    ...
    /// Ordinal for VMUX_PORT range assignment (monotonically increasing per app session)
    ...
    private func inheritedTerminalConfig(
        ...
        for terminalPanel in terminalPanelConfigInheritanceCandidates(
            ...
            var config = vmuxInheritedSurfaceConfig(
    ...
    func closePanel(_ panelId: UUID, force: Bool = false) -> Bool {
        ...
        let firstResponderPanelId = vmuxOwningGhosttyView(
    ...
    private func promptMovePanel(tabId: TabID) {
        ...
        if !moved {
            ...
            failure.informativeText = String(localized: "dialog.moveFailed.message", defaultValue: "vmux could not move this tab to the selected destination.")
...
extension Workspace: BonsplitDelegate {
    ...
    func splitTabBar(_ controller: BonsplitController, didSplitPane originalPane: PaneID, newPane: PaneID, orientation: SplitOrientation) {
        ...
        // tab in the source pane to avoid leaving it tabless. In vmux, this is undesirable:
