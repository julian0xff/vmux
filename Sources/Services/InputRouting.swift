...
func vmuxOwningGhosttyView(for responder: NSResponder?) -> GhosttyNSView? {
    ...
    if let view = responder as? NSView,
       let ghosttyView = vmuxOwningGhosttyViewFromView(view) {
        return ghosttyView
    }

    if let textView = responder as? NSTextView,
       let delegateView = textView.delegate as? NSView,
       let ghosttyView = vmuxOwningGhosttyViewFromView(delegateView) {
        return ghosttyView
    }
...
private func vmuxOwningGhosttyViewFromView(_ view: NSView) -> GhosttyNSView? {
