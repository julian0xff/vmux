...
/// the first responder.
final class VmuxWebView: WKWebView {
    ...
    static func hasRecentMiddleClickIntent(for webView: WKWebView) -> Bool {
        guard let webView = webView as? VmuxWebView else { return false }
    ...
    private static func recordMiddleClickIntent(for webView: VmuxWebView) {
    ...
    var contextMenuLinkURLProvider: ((VmuxWebView, NSPoint, @escaping (URL?) -> Void) -> Void)?
    ...
    private static let blockedDragTypes: Set<NSPasteboard.PasteboardType> = [
        ...
        NSPasteboard.PasteboardType("com.vmux.sidebar-tab-reorder"),
    ]
