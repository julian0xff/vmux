...
class UpdateDriver: NSObject, SPUUserDriver {
    ...
    func show(_ request: SPUUpdatePermissionRequest,
        ...
        if env["VMUX_UI_TEST_TRIGGER_UPDATE_CHECK"] == "1" || env["VMUX_UI_TEST_AUTO_ALLOW_PERMISSION"] == "1" {
...
#endif
        // Never show Sparkle's permission UI. vmux relies on its in-app update pill instead,
