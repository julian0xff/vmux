...
final class UpdateTestURLProtocol: URLProtocol {
    ...
    private static func appcastData() -> Data {
        ...
        let mode = env["VMUX_UI_TEST_FEED_MODE"] ?? "available"
        let version = env["VMUX_UI_TEST_UPDATE_VERSION"] ?? "9.9.9"
