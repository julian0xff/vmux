...
extension UNUserNotificationCenter {
    private static let removalQueue = DispatchQueue(
        label: "com.vmuxterm.notification-removal",
        qos: .utility
    )
...
enum NotificationSoundSettings {
    ...
    private static let customCommandQueue = DispatchQueue(
        label: "com.vmuxterm.notification-custom-command",
        qos: .utility
    )
...
final class TerminalNotificationStore: ObservableObject {
    ...
    static let categoryIdentifier = "com.vmuxterm.app.userNotification"
    static let actionShowIdentifier = "com.vmuxterm.app.userNotification.show"
    ...
    private func presentNotificationSettingsPrompt(attempt: Int) {
        ...
        alert.messageText = String(localized: "dialog.enableNotifications.title", defaultValue: "Enable Notifications for vmux")
        alert.informativeText = String(localized: "dialog.enableNotifications.message", defaultValue: "Notifications are disabled for vmux. Enable them in System Settings to see alerts.")
