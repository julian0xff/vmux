...
def wait_for_text(client: vmux, surface_id: str, needle: str, timeout: float = 3.0) -> bool:
...
def main() -> int:
    ...
    p1 = (tmp / "vmux drop [image] #1 (a).png").resolve()
    p2 = (tmp / "vmux drop second & file!.jpg").resolve()
