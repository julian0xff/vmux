#!/usr/bin/env python3
"""
Regression test: `vmux claude-teams --help` passes through to Claude.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="vmux-claude-teams-help-") as td:
        tmp = Path(td)
        home = tmp / "home"
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `vmux claude-teams --help` exited non-zero")
    ...
    print("PASS: vmux claude-teams forwards --help to Claude")
    return 0
