# Command Reference (vmux Markdown)

## Opening a Markdown Panel

```bash
vmux markdown open <path>
vmux markdown <path>          # shorthand (implicit "open")
```
...
|------|-------------|---------|
| `--workspace <id\|ref\|index>` | Target workspace | `$VMUX_WORKSPACE_ID` |
...
vmux markdown open ./plan.md
vmux markdown open /Users/me/project/plan.md
```
