...
```bash
vmux browser surface:7 snapshot
vmux browser surface:7 snapshot --interactive
vmux browser surface:7 snapshot --interactive --compact --max-depth 3
```

## Using Refs

```bash
vmux browser surface:7 click e6
vmux browser surface:7 fill e10 "user@example.com"
vmux browser surface:7 fill e11 "password123"
vmux browser surface:7 click e12
```
...
vmux browser surface:7 click e1
...
```bash
vmux browser surface:7 wait --selector "#target" --timeout-ms 10000
vmux browser surface:7 scroll --dy 400
vmux browser surface:7 snapshot --interactive
```
...
```bash
vmux browser surface:7 snapshot --selector "form#checkout" --interactive
```
