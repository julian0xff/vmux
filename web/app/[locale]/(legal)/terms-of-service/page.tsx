...
export const metadata: Metadata = {
  title: "Terms of Service — vmux",
  description: "Terms of service for vmux",
};
  ...
  return (
    <>
      ...
      <p>
        ...
        <a href="https://vmux.dev">vmux.dev</a> (the
        &ldquo;Site&rdquo;) and the vmux desktop application (the
